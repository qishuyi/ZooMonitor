...
* Effective use of R documents; we created an individual, but shared, R script to avoid the merge conflicts on Github
* Creation of visuals
  + 25 new visuals were sent to our client
...
* Creation of the generalized cleaning script
  + Created a script that cleans any animal data in the same way, taking the differences among the datasets into account 
