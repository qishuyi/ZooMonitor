...
* Since we had created a wider variety of plots at this point, we were curious if she had new ideas in mind. 
...
* Cattles generally spend more active around 10am and 11am and more inactive after lunch time
...
* The raw counts of observations is included in the visual since they normally differ substantially between before/after
...
* Note that the subject animal (the one that passed away/joined the zoo) is **excluded** from the pie charts, that is to say, both pie charts (before and after) represent the proportions of the behavior of all animals but the subject one.
...
* Pie chart: Falsely reported events' dates
  + Anna reported that Damian and Pistacio passed away on 2/22/2018 and 12/3/2018, respectively.
  + However, observations of them existed after those dates, even until recently.
  + Therefore, by excluding the subject animal (Damian or Pistacio), we obtained a decreased row count for the "After" period, which is not supposed to be the case (since they are not supposed to have existed then)
  + This might have happened because the zoo keepers might have mistakenly recorded some other animal under Damian's/Pistacio's name (they have their names recorded sporadiacally after their reporded date of death).
  + This does not affect our app because we let the users choose any date, so as long as they know the actual date of the event, the app will function properly.
