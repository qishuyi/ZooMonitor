...
* We observe that excluding the subject animals does not make a stark difference from the ones including them
* The pie charts in our app *include* the subject animals because we do not know if the selected event (date) involves any animal
