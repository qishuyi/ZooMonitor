...
* Note that, for each animal, the first row of pie charts *include* the subject animal (the one that passed away/joined the zoo) and the second row of pie charts *exclude* them.
