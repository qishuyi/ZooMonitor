...
* Dealing with falsely reported animal names
  ...
  + Therefore, by excluding the subject animal (Damian or Pistacio), we obtained a decreased row count for the "After" period, where we may have removed observations of an alive animal that was falsely reported
