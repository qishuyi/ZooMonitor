...
* Pie chart's inclusion/exclusion of the subject animal
  ...
  + The problem we encountered is that the subject individual will be present in only one of the pies (before or after), and this might affect the behavior proportion significantly.
  ...
  + Ended up INCLUDING it for now and asking our client in the next meeting if she want the excluded version. 
\
