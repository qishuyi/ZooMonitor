...
ggplot(summary_Damian, aes(x="", y=percent, fill=fct_reorder(Activity, desc(percent)))) + geom_bar(stat="identity", width=1) +
  ...
  labs(x = NULL, y = NULL, fill = NULL, title = "Damian's Death and Activity", subtitle = "Raw Counts: Before = 399, One month after = 159, After = 1962") +
...
ggplot(summary_Damian, aes(x="", y=percent, fill=fct_reorder(Activity, desc(percent)))) + geom_bar(stat="identity", width=1) +
  facet_grid(.~ Period) +
  coord_polar("y", start=0) + 
  labs(x = NULL, y = NULL, fill = NULL, title = "Damian's Death and Activity (without Damian)", subtitle = "Raw Counts: Before = 317, One month after = 158, After = 1841") +
  guides(fill = guide_legend(reverse = TRUE, override.aes = list(size = 1))) +
  theme_classic() + theme(axis.line = element_blank(),
                          axis.text = element_blank(),
                          axis.ticks = element_blank(),
...
ggplot(summary_Pistacio, aes(x="", y=percent, fill=fct_reorder(Activity, desc(percent)))) + geom_bar(stat="identity", width=1) +
  facet_grid(.~ Period) +
  coord_polar("y", start=0) + 
  labs(x = NULL, y = NULL, fill = NULL, title = "Pistacio's Death and Activity", subtitle = "Raw Counts: Before = 760, After = 1760") +
  guides(fill = guide_legend(reverse = TRUE, override.aes = list(size = 1))) +
  theme_classic() + theme(axis.line = element_blank(),
                          axis.text = element_blank(),
                          axis.ticks = element_blank(),
...
ggplot(summary_Pistacio, aes(x="", y=percent, fill=fct_reorder(Activity, desc(percent)))) + geom_bar(stat="identity", width=1) +
  facet_grid(.~ Period) +
  coord_polar("y", start=0) + 
  labs(x = NULL, y = NULL, fill = NULL, title = "Pistacio's Death and Activity (without Pistacio)", subtitle = "Raw Counts: Before = 591, After = 1673") +
  guides(fill = guide_legend(reverse = TRUE, override.aes = list(size = 1))) +
  theme_classic() + theme(axis.line = element_blank(),
                          axis.text = element_blank(),
                          axis.ticks = element_blank(),
...
* Note that, for each animal, the first pie charts *include* the subject animal (the one that passed away/joined the zoo) and the second ones *exclude* them.
