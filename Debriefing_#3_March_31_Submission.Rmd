...
* Last time, she said she wanted in the program the three plots that we sent her at the first meeting (2/6):
...
* We suggested that we create input sections in the program so that the user can choose a factor by which they facet the data, e.g., day of week, time of day, animal's name, etc.
