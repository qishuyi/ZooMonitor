...
* We showed her plots and tables we had created to answer her questions about Cattles and Squirrel Monkeys
...
* Cattles generally are more active around 10am and 11am and more inactive after lunch time
...
* Note that, for each animal, the first pie chart *includes* the subject animal (the one that passed away/joined the zoo) and the second ones *exclude* them.
