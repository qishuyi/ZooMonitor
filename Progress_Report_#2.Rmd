...
+ **Figure 1**: Barplots displaying the frequency and percentage of dogs' active and inactive behaviors based on the six-month intervals. This plot helps you discover the shifts in dogs' different types of activeness and inactiveness throughout the observational period.  
...
* The plot **a** and plot **b** illustrate the frequency and percentage of different types of **active** behaviors recorded in six-month intervals.
...
* The plot **c** and plot **d** illustrate the frequency and percentage of different types of **inactive** behaviors recorded in six-month intervals.
