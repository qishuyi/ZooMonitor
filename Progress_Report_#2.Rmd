...
#### **Notes**
Hello Anna! We have created the visualizations that you requested during the first meeting back in the beginning of February and in the follow up email. Figure 1 is ... . Figure 2 is a barplot displaying the percentage of observations per day of week, and the time of day. This plot is useful in identifying certian days of the week or times of the day where few/many observations are recorded. We hope that the visualizations we created in this progress report is helpful for you! 
