...
#### **Notes**
Hello Anna! We have created some visualizations that you requested during the first meeting and in the follow-up email. The figures include:  
\

+ **Figure 1**: a barplot displaying the frequency of dogs' inactive behaviors based on the six-month intervals. This plot helps you discover the shifts in dogs' inactiveness throughout the observational period.  
+ **Figure 2**: a barplot displaying the percentage of observations per day of week, and time of day. This plot is helpful in identifying certian days of the week or times of the day where few/many observations have been recorded.
